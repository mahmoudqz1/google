...
import AddDocuments from '@/pages/AddDocuments.vue'; // Import AddDocuments component
...
export default {
  ...
  components: {
    LeadTimeline,
    AddDocuments, // Register AddDocuments component
  },
  data() {
    return {
      headers: [
      ...
      selectedLeads: [],
      showTimeline: false,
      showDocumentsDialog: false, // State for showing the documents dialog
      currentLead: null,
  ...
  methods: {
    ...
    viewDetails(item) {
      ...
      console.log('Viewing details for lead:', this.currentLead)
    },
    openDocumentsDialog(item) {
      this.currentLead = item
      this.showDocumentsDialog = true
      console.log('Opening documents dialog for lead:', this.currentLead)
    },

...
export default {
  data() {
    return {
      ...
      users: [
        { id: 1, name: 'Mr carrez', email: 'jb.carrez@carrezconseil.fr', password: '111333555', role: 'Admin', showPassword: false },
        { id: 2, name: 'Sophie', email: 'sophie@carrezconseil.fr', password: '123456', role: 'Team leader', showPassword: false },
        { id: 2, name: 'Saad jaafri', email: 's.jaafri@carrezconseil.fr', password: '123456789', role: 'Agent', showPassword: false },
        
      ],
      roles: ['Admin', 'Team leader', 'Agent', 'Gestion'],
      addDialog: false,
      isEdit: false,
      newUser: {
        id: null,
